...
Comprehensive Bash scripting patterns. Apply these on top of the strict-mode foundation in the
main SKILL.md.
...
- Prefer Bash builtins (`[[`, `(( ))`, parameter expansion) over forking external commands
  (`grep`, `sed`, `awk`) inside tight loops.
