 ...
 *
 * Usage: bun run render.ts --input diagram.mmd --output diagram --theme tokyo-night bun run
 *   render.ts --code "graph TD; A-->B" --output diagram
 *
 * Runtimes: bun run render.ts ... npx tsx render.ts ... deno run --allow-read --allow-write
 *   --allow-net render.ts ...
 *
 * Output: Produces <output>.svg
 */
