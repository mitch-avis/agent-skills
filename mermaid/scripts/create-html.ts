 ...
 *
 * Usage: bun run create-html.ts --svg diagram.svg --output diagram.html bun run create-html.ts
 *   --svg diagram.svg --output diagram.html --padding 40
 *
 * Runtimes: bun run create-html.ts ... npx tsx create-html.ts ... deno run --allow-read
 *   --allow-write create-html.ts ...
 */
...
function main(): void {
  ...
  // Create HTML wrapper optimised for high-resolution screenshot SVG renders at natural size with
  // generous padding, no constraints
